...
**Paste it into the project description field as well.** The organisers'
2026-09-03 Discord reminder singles this requirement out and says it may live
in "a slide in your presentation, a section of your project description, or a
page in your repo". Ours is currently only the third, which needs a judge to
click through and pick the right filename. Pasting the same markdown into the
description costs nothing and makes it unmissable.
...
```bash
git pull && .venv/bin/python -m pytest -q      # expect 297 passed, 1 skipped
